            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-xs-12">
                        <div class="white-box">
                            <h3 class="box-title">Grafik Perjalanan Dinas Yang Selesai</h3>
                            <ul class="list-inline text-center m-t-40">
                                <li>
                                    <h5><i class="fa fa-circle m-r-5" style="color: #444b4c;"></i>Komisi A</h5>
                                </li>
                                <li>
                                    <h5><i class="fa fa-circle m-r-5" style="color: #fdc006;"></i>Komisi B</h5>
                                </li>
                                <li>
                                    <h5><i class="fa fa-circle m-r-5" style="color: #808f8f;"></i>Komisi C</h5>
                                </li>
                                <li>
                                    <h5><i class="fa fa-circle m-r-5" style="color: #808f8f;"></i>Komisi D</h5>
                                </li>
                            </ul>
...
<script type="text/javascript">
    ...
    Morris.Area({
        ...
        data: [{
                ...
                labels: ['Komisi A', 'Komisi B', 'Komisi C'],
                pointSize: 0,
                lineWidth: 0,
                resize:true,
                fillOpacity: 0.8,
