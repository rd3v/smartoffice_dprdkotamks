                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <div class="well alert-danger well-sm">
                                <h4>STATUS : DITOLAK</h4>
                                <hr>
                                <h4>Koreksi : </h4>
                                <h4 style="margin-left:4em">Foto Tiket Perjalanan tidak jelas</h4>
                            </div>
...
<embed src="{{ asset('public/perjalanandinas/laporan.pdf') }}" width="900" height="800" alt="pdf" pluginspage="http://www.adobe.com/products/acrobat/readstep2.html">
                                        ...
                                        <div class="form-actions">
                                            <a style="color:white" href="{{ url()->previous() }}" class="btnterima btn btn-success"> <i class="fa fa-check"></i> SIMPAN</a>
