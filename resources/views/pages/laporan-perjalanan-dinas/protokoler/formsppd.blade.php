        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row bg-title" style="background:url({{ asset('public/assets/v2/plugins/images/heading-title-bg.jpg') }}) no-repeat center center /cover;">
                    <div class="col-lg-12">
                        <h4 class="page-title">Form SPPD</h4>
                    </div>
                    <div class="col-sm-6 col-md-6 col-xs-12">
                        <ol class="breadcrumb pull-left">
                            <li><a href="{{ url('/') }}">Dashboard</a></li>
                            <li><a href="{{ url('keuangan/laporan-perjalanan-dinas') }}">Laporan Perjalanan Dinas</a></li>
...
<embed src="{{ asset('public/perjalanandinas/laporan.pdf') }}" width="900" height="800" alt="pdf" pluginspage="http://www.adobe.com/products/acrobat/readstep2.html">
                                        ...
                                        <div class="form-actions">
                                            <a style="color:white" href="{{ url()->previous() }}" class="btnterima btn btn-success"> <i class="fa fa-check"></i> DITERIMA</a>
                                            <button type="button" class="btntolak btn btn-danger"> <i class="fa fa-close"></i> DITOLAK</button>
