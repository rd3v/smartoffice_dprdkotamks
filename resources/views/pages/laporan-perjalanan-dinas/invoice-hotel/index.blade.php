                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="white-box p-0">
                           <h3 class="box-title m-b-0">Invoice Hotel</h3>
                            ...
                            <p><button class="btn btn-success btn-sm" data-toggle="modal" data-target="#add-contact">Tambah Invoice Hotel +</button></p>
                                ...
                                <table id="myTable" class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="{{ asset('assets/v2/images/invoice-hotel.png') }}" target="_blank"><img src="{{ asset('assets/v2/images/invoice-hotel.png') }}" alt="" width="50%"></a></td>
